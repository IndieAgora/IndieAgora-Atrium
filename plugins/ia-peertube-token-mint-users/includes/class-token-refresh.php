...
class IA_PeerTube_Token_Refresh {
    ...
    public static function maybe_refresh(int $phpbb_user_id, array $row, int $skewSeconds = 120): array {
        ...
        ia_pt_trace_log('ia-pt-refresh.refresh_grant.begin', ['phpbb_user_id' => $phpbb_user_id, 'context' => 'refresh_token']);
        ...
        if (is_wp_error($resp)) {
            ia_pt_trace_log('ia-pt-refresh.refresh_grant.fail', ['phpbb_user_id' => $phpbb_user_id, 'http' => 0, 'message' => $resp->get_error_message()]);
        ...
        if ($code < 200 || $code >= 300) {
            ia_pt_trace_log('ia-pt-refresh.refresh_grant.fail', ['phpbb_user_id' => $phpbb_user_id, 'http' => $code, 'message' => substr($body,0,160)]);
        ...
        ia_pt_trace_log('ia-pt-refresh.refresh_grant.ok', ['phpbb_user_id' => $phpbb_user_id, 'http' => $code]);
