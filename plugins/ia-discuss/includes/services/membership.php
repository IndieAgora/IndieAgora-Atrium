...
final class IA_Discuss_Service_Membership {
  ...
  /**
   * List phpBB user IDs who have enabled the Agora notification bell for a forum.
   * Used for reply-email recipient resolution.
   */
  public function list_notify_users(int $forum_id): array {
    $forum_id = (int)$forum_id;
