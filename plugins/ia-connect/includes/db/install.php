...
function ia_connect_db_install(): void {
  ...
  $folls = $wpdb->prefix . 'ia_connect_follows';
...
$sql4 = "CREATE TABLE $folls (
  id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  post_id BIGINT(20) UNSIGNED NOT NULL,
  follower_wp_id BIGINT(20) UNSIGNED NOT NULL DEFAULT 0,
  follower_phpbb_id BIGINT(20) UNSIGNED NOT NULL DEFAULT 0,
  created_at DATETIME NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY uniq_follow (post_id, follower_wp_id),
  KEY follower (follower_wp_id, post_id),
  KEY post (post_id, id)
) $charset;";


  $rels = $wpdb->prefix . 'ia_user_relations';

  $sql5 = "CREATE TABLE $rels (
    id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
function ia_connect_db_tables_exist(): bool {
  ...
  $tables = [
    ...
    $wpdb->prefix . 'ia_connect_follows',
    $wpdb->prefix . 'ia_user_relations',
  ];
  foreach ($tables as $t) {
